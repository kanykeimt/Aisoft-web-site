...
const initData = {
    heading: "О компании",
    content: "AiSoft — инновационная технологическая компания, специализирующаяся на разработке программного обеспечения и цифровых решений. Мы помогаем клиентам воплощать их идеи в жизнь, создавая высококачественные и эффективно работающие платформы. Наше внимание сосредоточено на двух ключевых аспектах: коммуникация и качество.",
