...
const initData = {
    heading: "Совершенствуйтесь вместе с нами! ",
    content: "Мы предлагаем готовые IT-решения, включая бизнес-инструменты для успешного функционирования учебных заведений, систему электронного документооборота, а также индивидуальную разработку. Наши решения помогут вам эффективно управлять процессами и обеспечивать высокий уровень безопасности в вашей организации. Позвольте нам внести технологические инновации в ваш бизнес и достичь новых высот вместе! ",
